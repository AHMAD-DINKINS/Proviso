...
class Problem:
    def __init__(self, sln, projectName, testDebugFolder, testDll, testFileName, testNamespace, testClass, testFileNamePath, puts, classUnderTestFile, muts):
        self.sln = sln
        ...
        self.testFileNamePath = testFileNamePath
        self.puts = puts
        self.classUnderTestFile = classUnderTestFile
        self.muts = muts
    ...
    def ExtractObservers(self, PUTName, outputFile, mode):
        ...
        assert (os.path.exists(os.path.abspath('ObserverExtractor/ObserverExtractor/bin/Debug/ObserverExtractor.exe'))), "feature extractor should exists"
    ...
    def ReadObserversFromFile(self, outputFile):
        ...
        for line in lines:
            ...
            varName = line[0]
            varType = line[1]
            precisFeatureTuple += (PrecisFeature(False, varName, varType, varName.startswith("New"), None),)

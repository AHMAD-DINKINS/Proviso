...
class PrecisFeature:
    ...
    def __init__(self, isDerived, varName, varType:str, isNew=None, varZ3=None):
        ...
        #if self.atom == None:
        arithRefId = FreshInt("cond") # freshInt adds '!' between prefix and identifier so we have to remove it
